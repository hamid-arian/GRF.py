...
from tree_options import TreeOptions  # Assuming TreeOptions is defined in a separate file
from sampling_options import SamplingOptions  # Assuming SamplingOptions is defined in a separate file
